...
First thing you schould look at ist the [Architecture Overview](/quickGuide/architecture.md) for a general feel to the architecture.

The general game content can be read in the [Gameworld and Gameplay Guide](/rules/dungeon.md).
...
Game Rules are beeing partly updated at the moment, there might be some inconsistencies.
