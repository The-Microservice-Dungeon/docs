...
First thing you should look at is the [Architecture Overview](/quickGuide/architecture.md) for a general feel to the architecture.
...
Game Rules are being partly updated at the moment, there might be some inconsistencies.
